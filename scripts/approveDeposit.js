...
const ABI = require("../artifacts/contracts/land.sol/land.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("land");
  const nft = await NFT.attach("0x24524DCf26df9601c0B16dcA17540baae763b3B1");
